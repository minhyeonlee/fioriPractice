		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Binding Demo",
									"targetURL": "#sync04zfc0242-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0242-display": {
								"semanticObject": "sync04zfc0242",
								"action": "display",
								"description": "Data Binding array",
								"title": "Binding Demo",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0242",
									"url": sap.ui.require.toUrl("sync04/zfc0242")
								}
							}
						}
					}
