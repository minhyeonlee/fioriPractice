		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Layout Demo",
									"targetURL": "#sync04zfc0220-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0220-display": {
								"semanticObject": "sync04zfc0220",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0220",
									"url": sap.ui.require.toUrl("sync04/zfc0220")
								}
							}
						}
					}
