		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Data Binding Prac 2",
									"targetURL": "#sync04zfc0240-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0240-display": {
								"semanticObject": "sync04zfc0240",
								"action": "display",
								"description": "Data Binding with List Box",
								"title": "Data Binding Prac 2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0240",
									"url": sap.ui.require.toUrl("sync04/zfc0240")
								}
							}
						}
					}
