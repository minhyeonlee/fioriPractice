		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sync04zfc0270-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0270-display": {
								"semanticObject": "sync04zfc0270",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0270",
									"url": sap.ui.require.toUrl("sync04/zfc0270")
								}
							}
						}
					}
