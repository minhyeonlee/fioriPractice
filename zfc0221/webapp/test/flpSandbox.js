		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fragment",
									"targetURL": "#sync04zfc0221-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0221-display": {
								"semanticObject": "sync04zfc0221",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0221",
									"url": sap.ui.require.toUrl("sync04/zfc0221")
								}
							}
						}
					}
