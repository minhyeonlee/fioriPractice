		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dialog(popup)",
									"targetURL": "#sync04zfc0222-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0222-display": {
								"semanticObject": "sync04zfc0222",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0222",
									"url": sap.ui.require.toUrl("sync04/zfc0222")
								}
							}
						}
					}
