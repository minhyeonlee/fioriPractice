		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Data Binding Prac 1",
									"targetURL": "#sync04zfc0230-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0230-display": {
								"semanticObject": "sync04zfc0230",
								"action": "display",
								"description": "Data Binding 0308 Friday",
								"title": "Data Binding Prac 1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0230",
									"url": sap.ui.require.toUrl("sync04/zfc0230")
								}
							}
						}
					}
