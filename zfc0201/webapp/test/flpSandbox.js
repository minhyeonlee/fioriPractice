		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello SAPUI5",
									"targetURL": "#sync04zfc0201-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0201-display": {
								"semanticObject": "sync04zfc0201",
								"action": "display",
								"description": "Hello SAPUI5",
								"title": "Hello SAPUI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0201",
									"url": sap.ui.require.toUrl("sync04/zfc0201")
								}
							}
						}
					}
