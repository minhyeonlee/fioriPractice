		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Combo Box",
									"targetURL": "#sync04zfc0241-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0241-display": {
								"semanticObject": "sync04zfc0241",
								"action": "display",
								"description": "Combo Box Prac 240311",
								"title": "Combo Box",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0241",
									"url": sap.ui.require.toUrl("sync04/zfc0241")
								}
							}
						}
					}
