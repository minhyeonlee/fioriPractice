		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Data Binding Prac02",
									"targetURL": "#sync04zfc0231-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0231-display": {
								"semanticObject": "sync04zfc0231",
								"action": "display",
								"description": "Data Binding Error ex and Multi Model",
								"title": "Data Binding Prac02",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0231",
									"url": sap.ui.require.toUrl("sync04/zfc0231")
								}
							}
						}
					}
