		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sync04zfc0250-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0250-display": {
								"semanticObject": "sync04zfc0250",
								"action": "display",
								"description": "Combo box data bindng",
								"title": "Binding Demo 2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0250",
									"url": sap.ui.require.toUrl("sync04/zfc0250")
								}
							}
						}
					}
